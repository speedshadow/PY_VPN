...
class SpinAttemptAdmin(admin.ModelAdmin):
    ...
    has_submitted_email.short_description = 'Email Submetido?'
    ...
    # Para um filtro mais avançado de "Vencedores" vs "Não Vencedores",
    # poderíamos criar um SimpleListFilter personalizado.
    # Por agora, filtrar por 'winner_email' (vazio/não vazio) e 'prize_won' (vazio/não vazio) deve ajudar.
